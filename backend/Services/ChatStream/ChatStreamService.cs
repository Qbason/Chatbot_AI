...
namespace ChatbotAIService.Services
{
    public class ChatStreamService : IChatStreamService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            await UpdateConversation(conversationId, ConversationStatus.Streaming, cancellationToken);
        ...
        private async Task<bool> UpdateConversation(
            int conversationId, 
            ...
            [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            await foreach (var completionUpdate in completionUpdates.WithCancellation(cancellationToken))
            {
                if (cancellationToken.IsCancellationRequested)
                {
                    ...
                    await _mediator.Send(new UpdateConversationStatusCommand
                    {
                        ConversationId = conversationId,
